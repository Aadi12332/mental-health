...
const faqs = [
  ...
  },
  {
    ...
    paragraphs: ["Getting started is simple and fully online:"],
    list: [
  ...
  },
  {
    ...
    paragraphs: ["During your first session, your provider will:"],
    list: [
    ...
    <section className="py-20 bg-white">
      <div className="max-w-[1440px] mx-auto lg:px-6 px-3">
        <h2 className="text-center text-4xl lg:text-5xl font-semibold mb-16 flex items-center gap-3 justify-center">
          <GradientButton fontSize="text-center text-4xl lg:text-5xl font-semibold">
            FAQs
          </GradientButton>
        </h2>
